...
export default function MoodersMenu() {
  ...
  React.useEffect(() => {
    if (isDarkMode) {
      containerRef.current?.style.setProperty("--background", "black");
      containerRef.current?.style.setProperty("--foreground", "white");
    } else {
      containerRef.current?.style.setProperty("--background", "white");
      containerRef.current?.style.setProperty("--foreground", "black");
    }
  }, [isDarkMode]);
  ...
  return (
    <div className={classes["container"]} ref={containerRef}>
      <div
        className={classes["container__backdrop"]}
        style={{
      ...
      <div className={classes["container__header"]}>
        <div className={classes["container__header-content"]}>
          <svg
            width="85"
            height="15"
            viewBox="0 0 85 15"
      ...
      <div
        className={classes["container__menu"]}
        style={{
          pointerEvents: showMenu ? "all" : "none",
        }}
      >
        <div
          className={classes["container__menu-column"]}
          style={{
            transform: showMenu
              ? "translateY(0%)"
              : "translateY(calc(-100% - 2.25rem - 50px))",
            transitionDelay: "0s",
          }}
        >
          <MenuSection>motion motion trailer</MenuSection>
          <MenuSection>a year in review</MenuSection>
          <MenuSection>celebrate with carter</MenuSection>
          <MenuSection className={classes["container__menu-section-title"]}>
            works
          </MenuSection>
        </div>
        <div
        ...
        >
          <MenuSection>we are composers</MenuSection>
          <MenuSection>we are sound engineers</MenuSection>
          <MenuSection>we are a music creative team</MenuSection>
          <MenuSection className={classes["container__menu-section-title"]}>
            about
          </MenuSection>
        </div>
        ...
        >
          <MenuSection>what is sound design?</MenuSection>
          <MenuSection>multi-channel sound design</MenuSection>
          <MenuSection>sound design boosted</MenuSection>
          <MenuSection className={classes["container__menu-section-title"]}>
            news
          </MenuSection>
        </div>
...
function MenuSection({
  ...
  return (
    <div className={classes["container__menu-section-section"]}>
